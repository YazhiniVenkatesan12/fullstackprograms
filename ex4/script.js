...
const restaurants = [
    { id: 1, name: 'Pizza Hut', menu: ['Margherita', 'Pepperoni', 'BBQ Chicken'] },
    { id: 2, name: 'Burger Joint', menu: ['Classic Zinger Burger', 'Cheese Burger', 'Veggie Burger'] },
    { id: 3, name: 'Biriyani Corner', menu: ['Chicken Biriyani', 'Mutton Biriyani', 'Paneer Biriyani'] }
];
